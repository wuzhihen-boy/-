...
window.addEventListener('load', function() {
    (function() {
        ...
        var i = 0
          , flag = true;
        var imgArr = {
            'big': ['../img/p1.png', '../img/p2.png', '../img/p3.png', '../img/p4.png', '../img/p5.png', '../img/p6.png'],
            'small': ['../img/small-p1.png', '../img/small-p2.png', '../img/small-p3.png', '../img/small-p4.png', '../img/small-p5.png', '../img/small-p6.png']
        };
        var arr = [];
